...
module.exports = function (RED: Red) {
    function WorkflowFailNode(config: NodeProperties & { [key: string]: any }) {
    ...
    RED.nodes.registerType("mcma-workflow-fail", WorkflowFailNode);
};
            ...
            await new Promise<any>((resolve, reject) => {
                const sandbox = {
                    ...
                    input: {
                        ...
                        status: "Failed",
                        error: msg.payload?.error ?? msg.error?.message
                    },
                    tracker: msg.tracker,
                    resolve,
                    reject,
